...
/**
 * print_magic - A program that prints the
 * magic numbers of an ELF header.
 * @e_ident: pointer
 *
 * Description: Magic numbers will be separated by the spaces.
 */
...
/**
 * print_class - Write a program that prints
...
/**
 * print_version - Write a fucntion that prints
...
/**
 * print_abi - A program that prints the
 * ABI version of an ELF header.
...
/**
 * print_type - Write a program that prints the type of an ELF header.
 * @e_type: Elf type
 * @e_ident: pointer
 */
...
/**
 * print_entry - Write a program that prints
 * the entry point of an ELF header.
 * @e_entry: The location or address
 * @e_ident: pointer
 */
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	a = read(fdes, header, sizeof(Elf64_Ehdr));
	if (a == -1)
	{
		free(header);
		close_elf(fdes);
